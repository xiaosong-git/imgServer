package com.xdream.uaas.dao.base.impl;


import com.xdream.uaas.dao.base.IMyBaseDao;
import com.xdream.uaas.model.compose.Constants;
...
public class MyBaseDaoImpl implements IMyBaseDao {
    ...
    public int update(String tableName, Map<String, Object> params) {
        ...
        for (String key : keySet){
            ...
            if("null".equals(value+"")){
                ...
                sb.append(key +" = '" +new SimpleDateFormat(Constants.DATE_FORMAT_DEFAULT).format(value)+"' ,");
            }else if(value == null){
                sb.append(key +" = null ,");
            }
        }
    ...
    public int save(String tableName, Map<String, Object> params) {
        ...
        for (String key: keySet) {
            ...
            if(value instanceof  String){
                ...
                sb.append(" '"+new SimpleDateFormat(Constants.DATE_FORMAT_DEFAULT).format(value)+"',");
            }
        }
    ...
    public PageModel findPage(String coloumSql, String fromSql, Integer pageNum, Integer pageSize) {
        ...
        pageSize = pageSize == null ? Constants.PAGESIZE : pageSize;//为空设置默认
